...
import 'package:hand_core/src/components/common/ip_port_dropdown.dart';
  ...
  Widget _buildTerminalToolbar(BuildContext context, T terminalController) {
    return Row(
      ...
      children: [
        ...
        /// TODO: move this to specific terminal
        Row(
          mainAxisAlignment: MainAxisAlignment.start,
          children: [IpPortDropdown(ipPortList: terminalController.ipPortList)],
        ),
